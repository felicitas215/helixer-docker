...
RUN git clone https://github.com/weberlab-hhu/Helixer.git Helixer && cd Helixer && git checkout tags/v0.3.7 && pip install --no-cache-dir -r /home/helixer_user/Helixer/requirements.3.10.txt && pip install --no-cache-dir .
